...
import { Beef, CheckCircle, Truck } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col min-h-screen bg-antiqueWhite">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Card className="bg-deer max-w-2xl mx-auto">
          <CardHeader>
            <div className="flex items-center justify-center mb-4">
              <CheckCircle className="h-16 w-16 text-sepia" />
            </div>
            <CardTitle className="text-3xl font-bold text-center text-bistre">Order Confirmed!</CardTitle>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between">
                <span className="font-semibold text-bistre">Order Number:</span>
                <span className="text-sepia">{order.id}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-semibold text-bistre">Order Date:</span>
                <span className="text-sepia">{order.date}</span>
              </div>
              ...
              <div className="border-t border-sepia my-4"></div>
              <div className="flex justify-between">
                <span className="font-semibold text-bistre">Shipping:</span>
                <span className="text-sepia">${order.shipping}</span>
              </div>
              <div className="flex justify-between font-bold">
                <span className="text-bistre">Total:</span>
                <span className="text-sepia">${order.total}</span>
              </div>
            </div>
          </CardContent>
